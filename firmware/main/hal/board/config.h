...
/** CoreS3 HY2.0 Port A (red): Yellow=SDA, White=SCL — mBot RJ25 Port 1 breakout. */
#define MBOT_I2C_SDA_PIN GPIO_NUM_2
#define MBOT_I2C_SCL_PIN GPIO_NUM_1
#define MBOT_I2C_FREQ_HZ 100000
